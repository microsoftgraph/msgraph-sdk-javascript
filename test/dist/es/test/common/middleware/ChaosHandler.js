...
describe("ChaosHandler.ts", () => {
	...
	describe("sendRequest", () =>
		tslib_1.__awaiter(this, void 0, void 0, function*() {
			...
			const manualMap = new Map([["/me", new Map([["GET", 500]])]]);
			const tempManualOptions = new ChaosHandlerOptions(ChaosStrategy.MANUAL);
	...
	describe("setStatusCode", () => {
		const manualMap = new Map([["/me/messages/.*", new Map([["GET", 500], ["PATCH", 201]])], ["/me", new Map([["GET", 500], ["PATCH", 201]])]]);
		const tempManualOptions = new ChaosHandlerOptions(ChaosStrategy.MANUAL);
		const tempManualOptionsRegex = new ChaosHandlerOptions(ChaosStrategy.MANUAL);
	...
	describe("execute", () =>
		tslib_1.__awaiter(this, void 0, void 0, function*() {
			const manualMap = new Map([["/me", new Map([["GET", 500], ["PATCH", 201]])]]);
			const dummyHTTPHandler = new DummyHTTPMessageHandler();
