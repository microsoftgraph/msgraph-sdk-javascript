...
describe("RetryHandler.ts", function() {
	...
	describe("sleep", () =>
		tslib_1.__awaiter(this, void 0, void 0, function*() {
			it("Should run the sleep method for 1 second", () =>
				tslib_1.__awaiter(this, void 0, void 0, function*() {
					try {
	...
	describe("executeWithRetry", () =>
		tslib_1.__awaiter(this, void 0, void 0, function*() {
			...
			it("Should return non retried response incase of maxRetries busted out", () =>
				tslib_1.__awaiter(this, void 0, void 0, function*() {
			...
			it("Should return succeeded response for non retry response", () =>
				tslib_1.__awaiter(this, void 0, void 0, function*() {
			...
			it("Should return non retried response for streaming request", () =>
				tslib_1.__awaiter(this, void 0, void 0, function*() {
					const c = {
						request: "url",
						options: {
			...
			it("Should successfully retry and return ok response", () =>
				tslib_1.__awaiter(this, void 0, void 0, function*() {
			...
			it("Should fail by exceeding max retries", () =>
				tslib_1.__awaiter(this, void 0, void 0, function*() {
