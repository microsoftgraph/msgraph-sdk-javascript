...
describe("GraphResponseHandler.ts", () => {
	...
	describe("convertResponse", () => {
		it("Should return empty response for the NO CONTENT (204 response)", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
		...
		it("Should return empty text value for empty response", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
				const response = new Response(undefined, status202);
				const responseValue = yield GraphResponseHandler["convertResponse"](response);
				assert.isUndefined(responseValue);
			}));
		it("Should return text data for text/plain content-type", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
		...
		it("Should return json data for application/json content-type", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
				const data = {
					test: "test",
				};
		...
		it("Should return raw response incase of unknown content-type", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
		...
		it("Should return response value as text", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
				const response = new Response(htmlString, status200);
		...
		it("Should return response value as text for text/html return type", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
				const response = new Response(htmlString, status200);
		...
		it("Should return response value as json", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
		...
		it("Should return response value as text for default response type", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
				const response = new Response(htmlString, status200);
				const responseValue = yield GraphResponseHandler["convertResponse"](response);
				assert.isDefined(responseValue);
	...
	describe("getResponse", () => {
		...
		it("Should return valid 200 OK response", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
				const response = new Response(htmlString, status200);
