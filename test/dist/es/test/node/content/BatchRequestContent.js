...
describe("BatchRequestContent.ts", () => {
	...
	describe("getContent", () => {
		it("Should return error for empty requests", () =>
		...
		it("Should return image's base64 string", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
				const fileName = "sample_image.jpg";
				fs.readFile(`./spec/sample_files/${fileName}`, {}, (err, file) =>
					tslib_1.__awaiter(this, void 0, void 0, function*() {
						if (err) {
							throw err;
						}
		...
		it("Should throw error for request does not have content-type header if it does have a body", () =>
			tslib_1.__awaiter(this, void 0, void 0, function*() {
	...
	describe("validateDependencies", () => {
		...
		it("Should throw error for empty request object", (done) => {
			try {
				BatchRequestContent["validateDependencies"](new Map());
