...
export class RestoreRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ...
            ["parentReference", (o, n) => { (o as unknown as RestoreRequestBody).parentReference = n.getObjectValue<ItemReference>(ItemReference); }],
        ]);
    };
    /**
