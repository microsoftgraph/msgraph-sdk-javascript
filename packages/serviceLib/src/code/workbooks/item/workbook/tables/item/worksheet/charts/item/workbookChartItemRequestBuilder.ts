...
import {WorkbookChartSeriesItemRequestBuilder} from './series/item/';
...
export class WorkbookChartItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.workbooks.item.workbook.tables.item.worksheet.charts.item.series.item collection
