...
export class ApplyBottomPercentFilterRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["percent", (o, n) => { (o as unknown as ApplyBottomPercentFilterRequestBody).percent = n.getNumberValue(); }],
        ]);
    };
    /**
