...
export class DiscRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as DiscRequestBody).basis = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as DiscRequestBody).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as DiscRequestBody).pr = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as DiscRequestBody).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as DiscRequestBody).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
