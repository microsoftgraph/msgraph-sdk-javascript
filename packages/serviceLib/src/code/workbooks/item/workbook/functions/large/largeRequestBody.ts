...
export class LargeRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as LargeRequestBody).array = n.getObjectValue<Json>(Json); }],
            ["k", (o, n) => { (o as unknown as LargeRequestBody).k = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
