...
export class Hex2BinRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Hex2BinRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["places", (o, n) => { (o as unknown as Hex2BinRequestBody).places = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
