...
export class T_InvRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom", (o, n) => { (o as unknown as T_InvRequestBody).degFreedom = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as T_InvRequestBody).probability = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
