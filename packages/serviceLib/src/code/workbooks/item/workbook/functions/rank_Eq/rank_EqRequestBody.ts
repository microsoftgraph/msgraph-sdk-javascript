...
export class Rank_EqRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as Rank_EqRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["order", (o, n) => { (o as unknown as Rank_EqRequestBody).order = n.getObjectValue<Json>(Json); }],
            ["ref", (o, n) => { (o as unknown as Rank_EqRequestBody).ref = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
