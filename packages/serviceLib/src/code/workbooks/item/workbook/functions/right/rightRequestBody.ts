...
export class RightRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["numChars", (o, n) => { (o as unknown as RightRequestBody).numChars = n.getObjectValue<Json>(Json); }],
            ["text", (o, n) => { (o as unknown as RightRequestBody).text = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
