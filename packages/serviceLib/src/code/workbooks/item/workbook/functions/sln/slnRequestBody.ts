...
export class SlnRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cost", (o, n) => { (o as unknown as SlnRequestBody).cost = n.getObjectValue<Json>(Json); }],
            ["life", (o, n) => { (o as unknown as SlnRequestBody).life = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as SlnRequestBody).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
