...
export class F_Dist_RTRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["degFreedom1", (o, n) => { (o as unknown as F_Dist_RTRequestBody).degFreedom1 = n.getObjectValue<Json>(Json); }],
            ["degFreedom2", (o, n) => { (o as unknown as F_Dist_RTRequestBody).degFreedom2 = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as F_Dist_RTRequestBody).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
