...
export class SumIfsRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["sumRange", (o, n) => { (o as unknown as SumIfsRequestBody).sumRange = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as SumIfsRequestBody).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
