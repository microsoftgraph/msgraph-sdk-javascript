...
export class RoundRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as RoundRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["numDigits", (o, n) => { (o as unknown as RoundRequestBody).numDigits = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
