...
export class Norm_InvRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["mean", (o, n) => { (o as unknown as Norm_InvRequestBody).mean = n.getObjectValue<Json>(Json); }],
            ["probability", (o, n) => { (o as unknown as Norm_InvRequestBody).probability = n.getObjectValue<Json>(Json); }],
            ["standardDev", (o, n) => { (o as unknown as Norm_InvRequestBody).standardDev = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
