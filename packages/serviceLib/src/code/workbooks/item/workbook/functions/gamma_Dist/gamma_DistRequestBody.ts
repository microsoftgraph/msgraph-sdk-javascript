...
export class Gamma_DistRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["alpha", (o, n) => { (o as unknown as Gamma_DistRequestBody).alpha = n.getObjectValue<Json>(Json); }],
            ["beta", (o, n) => { (o as unknown as Gamma_DistRequestBody).beta = n.getObjectValue<Json>(Json); }],
            ["cumulative", (o, n) => { (o as unknown as Gamma_DistRequestBody).cumulative = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as Gamma_DistRequestBody).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
