...
export class IrrRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["guess", (o, n) => { (o as unknown as IrrRequestBody).guess = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as IrrRequestBody).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
