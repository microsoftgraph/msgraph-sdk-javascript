...
export class DminRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["criteria", (o, n) => { (o as unknown as DminRequestBody).criteria = n.getObjectValue<Json>(Json); }],
            ["database", (o, n) => { (o as unknown as DminRequestBody).database = n.getObjectValue<Json>(Json); }],
            ["field", (o, n) => { (o as unknown as DminRequestBody).field = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
