...
export class SmallRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as SmallRequestBody).array = n.getObjectValue<Json>(Json); }],
            ["k", (o, n) => { (o as unknown as SmallRequestBody).k = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
