...
export class BesselKRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["n", (o, n) => { (o as unknown as BesselKRequestBody).n = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as BesselKRequestBody).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
