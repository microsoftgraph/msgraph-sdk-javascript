...
export class PermutationaRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["number", (o, n) => { (o as unknown as PermutationaRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["numberChosen", (o, n) => { (o as unknown as PermutationaRequestBody).numberChosen = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
