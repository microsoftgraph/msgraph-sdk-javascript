...
export class Percentile_IncRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["array", (o, n) => { (o as unknown as Percentile_IncRequestBody).array = n.getObjectValue<Json>(Json); }],
            ["k", (o, n) => { (o as unknown as Percentile_IncRequestBody).k = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
