...
export class T_DistRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["cumulative", (o, n) => { (o as unknown as T_DistRequestBody).cumulative = n.getObjectValue<Json>(Json); }],
            ["degFreedom", (o, n) => { (o as unknown as T_DistRequestBody).degFreedom = n.getObjectValue<Json>(Json); }],
            ["x", (o, n) => { (o as unknown as T_DistRequestBody).x = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
