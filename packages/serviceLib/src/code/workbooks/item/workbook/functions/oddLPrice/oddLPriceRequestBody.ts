...
export class OddLPriceRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as OddLPriceRequestBody).basis = n.getObjectValue<Json>(Json); }],
            ["frequency", (o, n) => { (o as unknown as OddLPriceRequestBody).frequency = n.getObjectValue<Json>(Json); }],
            ["lastInterest", (o, n) => { (o as unknown as OddLPriceRequestBody).lastInterest = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as OddLPriceRequestBody).maturity = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as OddLPriceRequestBody).rate = n.getObjectValue<Json>(Json); }],
            ["redemption", (o, n) => { (o as unknown as OddLPriceRequestBody).redemption = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as OddLPriceRequestBody).settlement = n.getObjectValue<Json>(Json); }],
            ["yld", (o, n) => { (o as unknown as OddLPriceRequestBody).yld = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
