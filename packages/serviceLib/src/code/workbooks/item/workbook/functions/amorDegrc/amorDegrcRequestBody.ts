...
export class AmorDegrcRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as AmorDegrcRequestBody).basis = n.getObjectValue<Json>(Json); }],
            ["cost", (o, n) => { (o as unknown as AmorDegrcRequestBody).cost = n.getObjectValue<Json>(Json); }],
            ["datePurchased", (o, n) => { (o as unknown as AmorDegrcRequestBody).datePurchased = n.getObjectValue<Json>(Json); }],
            ["firstPeriod", (o, n) => { (o as unknown as AmorDegrcRequestBody).firstPeriod = n.getObjectValue<Json>(Json); }],
            ["period", (o, n) => { (o as unknown as AmorDegrcRequestBody).period = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as AmorDegrcRequestBody).rate = n.getObjectValue<Json>(Json); }],
            ["salvage", (o, n) => { (o as unknown as AmorDegrcRequestBody).salvage = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
