...
export class YieldMatRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["basis", (o, n) => { (o as unknown as YieldMatRequestBody).basis = n.getObjectValue<Json>(Json); }],
            ["issue", (o, n) => { (o as unknown as YieldMatRequestBody).issue = n.getObjectValue<Json>(Json); }],
            ["maturity", (o, n) => { (o as unknown as YieldMatRequestBody).maturity = n.getObjectValue<Json>(Json); }],
            ["pr", (o, n) => { (o as unknown as YieldMatRequestBody).pr = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as YieldMatRequestBody).rate = n.getObjectValue<Json>(Json); }],
            ["settlement", (o, n) => { (o as unknown as YieldMatRequestBody).settlement = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
