...
export class ChooseRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["indexNum", (o, n) => { (o as unknown as ChooseRequestBody).indexNum = n.getObjectValue<Json>(Json); }],
            ["values", (o, n) => { (o as unknown as ChooseRequestBody).values = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
