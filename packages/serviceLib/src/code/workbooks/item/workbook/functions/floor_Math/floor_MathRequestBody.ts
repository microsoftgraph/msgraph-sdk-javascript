...
export class Floor_MathRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["mode", (o, n) => { (o as unknown as Floor_MathRequestBody).mode = n.getObjectValue<Json>(Json); }],
            ["number", (o, n) => { (o as unknown as Floor_MathRequestBody).number = n.getObjectValue<Json>(Json); }],
            ["significance", (o, n) => { (o as unknown as Floor_MathRequestBody).significance = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
