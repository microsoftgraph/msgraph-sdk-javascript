...
export class IpmtRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["fv", (o, n) => { (o as unknown as IpmtRequestBody).fv = n.getObjectValue<Json>(Json); }],
            ["nper", (o, n) => { (o as unknown as IpmtRequestBody).nper = n.getObjectValue<Json>(Json); }],
            ["per", (o, n) => { (o as unknown as IpmtRequestBody).per = n.getObjectValue<Json>(Json); }],
            ["pv", (o, n) => { (o as unknown as IpmtRequestBody).pv = n.getObjectValue<Json>(Json); }],
            ["rate", (o, n) => { (o as unknown as IpmtRequestBody).rate = n.getObjectValue<Json>(Json); }],
            ["type", (o, n) => { (o as unknown as IpmtRequestBody).type = n.getObjectValue<Json>(Json); }],
        ]);
    };
    /**
