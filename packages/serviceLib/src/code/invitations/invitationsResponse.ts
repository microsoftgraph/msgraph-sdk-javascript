...
export class InvitationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as InvitationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as InvitationsResponse).value = n.getCollectionOfObjectValues<Invitation>(Invitation); }],
        ]);
    };
    /**
