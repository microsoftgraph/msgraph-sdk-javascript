...
export class DevicesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DevicesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DevicesResponse).value = n.getCollectionOfObjectValues<Device>(Device); }],
        ]);
    };
    /**
