...
export class ListItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}/listItem{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.drive.bundles.item.listItem.versions.item collection
