...
import {DriveItemItemRequestBuilder as if4d091e3505f9c34b0254cea0478dd414ffac183312bf2f4f0443247db4c6b20} from './children/item/driveItemItemRequestBuilder';
...
export class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.drive.bundles.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a driveItemItemRequestBuilder
     */
    public childrenById(id: string) : if4d091e3505f9c34b0254cea0478dd414ffac183312bf2f4f0443247db4c6b20 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem_id1"] = id
        return new if4d091e3505f9c34b0254cea0478dd414ffac183312bf2f4f0443247db4c6b20(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    /**
     * Gets an item from the MicrosoftGraph.drive.bundles.item.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drive.bundles.item.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drive.bundles.item.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drive.bundles.item.versions.item collection
     * @param id Unique identifier of the item
