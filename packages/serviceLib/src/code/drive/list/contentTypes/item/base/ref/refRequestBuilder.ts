...
/** Builds and executes requests for operations under /drive/list/contentTypes/{contentType-id}/base/$ref  */
export class RefRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType_id}/base/$ref";
