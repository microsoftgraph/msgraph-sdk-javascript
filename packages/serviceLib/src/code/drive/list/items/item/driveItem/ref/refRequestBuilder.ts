...
/** Builds and executes requests for operations under /drive/list/items/{listItem-id}/driveItem/$ref  */
export class RefRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drive/list/items/{listItem_id}/driveItem/$ref";
