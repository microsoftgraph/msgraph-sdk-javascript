...
export class AgreementsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AgreementsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AgreementsResponse).value = n.getCollectionOfObjectValues<Agreement>(Agreement); }],
        ]);
    };
    /**
