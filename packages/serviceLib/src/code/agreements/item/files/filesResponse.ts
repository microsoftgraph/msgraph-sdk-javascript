...
export class FilesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as FilesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as FilesResponse).value = n.getCollectionOfObjectValues<AgreementFileLocalization>(AgreementFileLocalization); }],
        ]);
    };
    /**
