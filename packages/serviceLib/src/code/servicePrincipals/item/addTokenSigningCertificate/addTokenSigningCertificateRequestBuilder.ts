...
export class AddTokenSigningCertificateRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: SelfSignedCertificateRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
     ...
     */
    public post(body: SelfSignedCertificateRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SelfSignedCertificate | undefined> {
        if(!body) throw new Error("body cannot be undefined");
