...
/** Builds and executes requests for operations under /education/users/{educationUser-id}/assignments/{educationAssignment-id}  */
export class EducationAssignmentRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.education.users.item.assignments.item.resources.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.education.users.item.assignments.item.submissions.item collection
     * @param id Unique identifier of the item
