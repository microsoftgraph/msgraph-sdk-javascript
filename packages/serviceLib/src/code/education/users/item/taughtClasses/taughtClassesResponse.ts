...
export class TaughtClassesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TaughtClassesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TaughtClassesResponse).value = n.getCollectionOfObjectValues<EducationClass>(EducationClass); }],
        ]);
    };
    /**
