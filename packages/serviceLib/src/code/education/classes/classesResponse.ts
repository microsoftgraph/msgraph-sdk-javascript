...
export class ClassesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ClassesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ClassesResponse).value = n.getCollectionOfObjectValues<EducationClass>(EducationClass); }],
        ]);
    };
    /**
