...
export class SubscribeToToneRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: SubscribeToToneRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
