...
export class StopHoldMusicRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["clientContext", (o, n) => { (o as unknown as StopHoldMusicRequestBody).clientContext = n.getStringValue(); }],
        ]);
    };
    /**
