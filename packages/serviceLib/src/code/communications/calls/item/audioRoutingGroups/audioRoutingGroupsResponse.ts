...
export class AudioRoutingGroupsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AudioRoutingGroupsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AudioRoutingGroupsResponse).value = n.getCollectionOfObjectValues<AudioRoutingGroup>(AudioRoutingGroup); }],
        ]);
    };
    /**
