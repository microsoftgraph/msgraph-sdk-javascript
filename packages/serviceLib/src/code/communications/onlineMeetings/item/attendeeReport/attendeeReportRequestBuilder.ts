...
/** Builds and executes requests for operations under /communications/onlineMeetings/{onlineMeeting-id}/attendeeReport  */
export class AttendeeReportRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/communications/onlineMeetings/{onlineMeeting_id}/attendeeReport";
