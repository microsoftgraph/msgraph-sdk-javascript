...
export class CallRecordsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as CallRecordsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as CallRecordsResponse).value = n.getCollectionOfObjectValues<CallRecord>(CallRecord); }],
        ]);
    };
    /**
