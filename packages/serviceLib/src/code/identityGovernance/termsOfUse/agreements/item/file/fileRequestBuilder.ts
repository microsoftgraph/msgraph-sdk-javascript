...
import {createAgreementFileFromDiscriminatorValue} from '../../../../../models/microsoft/graph/createAgreementFileFromDiscriminatorValue';
...
export class FileRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement_id}/file{?select,expand}";
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: AgreementFile | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AgreementFile | undefined> {
    ...
    /**
     * Gets an item from the MicrosoftGraph.identityGovernance.termsOfUse.agreements.item.file.localizations.item collection
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: AgreementFile | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
