...
export class AssignmentRequestsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AssignmentRequestsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AssignmentRequestsResponse).value = n.getCollectionOfObjectValues<AccessPackageAssignmentRequest>(AccessPackageAssignmentRequest); }],
        ]);
    };
    /**
