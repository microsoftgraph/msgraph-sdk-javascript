...
export class CatalogsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as CatalogsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as CatalogsResponse).value = n.getCollectionOfObjectValues<AccessPackageCatalog>(AccessPackageCatalog); }],
        ]);
    };
    /**
