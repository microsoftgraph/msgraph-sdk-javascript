...
import {SectionGroupItemRequestBuilder as ib74cf7baa1ec0f6c1d4de4d4ecd3e3059366afb2ef5d1e1e2150291ca2a0108b} from './sectionGroups/item/sectionGroupItemRequestBuilder';
...
export class SectionGroupItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.item.onenote.notebooks.item.sectionGroups.item.sectionGroups.item collection
     * @param id Unique identifier of the item
     * @returns a sectionGroupItemRequestBuilder
     */
    public sectionGroupsById(id: string) : ib74cf7baa1ec0f6c1d4de4d4ecd3e3059366afb2ef5d1e1e2150291ca2a0108b {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup_id1"] = id
        return new ib74cf7baa1ec0f6c1d4de4d4ecd3e3059366afb2ef5d1e1e2150291ca2a0108b(urlTplParams, this.requestAdapter);
    };
    /**
     * Gets an item from the MicrosoftGraph.sites.item.onenote.notebooks.item.sectionGroups.item.sections.item collection
     * @param id Unique identifier of the item
