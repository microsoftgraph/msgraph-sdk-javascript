...
export class OnenoteSectionItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.item.onenote.sectionGroups.item.sections.item.pages.item collection
