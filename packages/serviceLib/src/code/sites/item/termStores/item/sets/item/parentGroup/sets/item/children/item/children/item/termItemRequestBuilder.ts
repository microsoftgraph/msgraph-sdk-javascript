...
export class TermItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}/children/{term_id1}{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.item.termStores.item.sets.item.parentGroup.sets.item.children.item.children.item.relations.item collection
