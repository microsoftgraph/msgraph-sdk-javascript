...
import {TermItemRequestBuilder as i08a53e0f5f9ab48a2c9d8d2617edc8fa18467e8677aeed0f26d51f0698d8fee3} from './children/item/';
...
/** Builds and executes requests for operations under /sites/{site-id}/termStores/{store-id}/sets/{set-id}/terms/{term-id}  */
export class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.item.termStores.item.sets.item.terms.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a termItemRequestBuilder
     */
    public childrenById(id: string) : i08a53e0f5f9ab48a2c9d8d2617edc8fa18467e8677aeed0f26d51f0698d8fee3 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term_id1"] = id
        return new i08a53e0f5f9ab48a2c9d8d2617edc8fa18467e8677aeed0f26d51f0698d8fee3(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    /**
     * Gets an item from the MicrosoftGraph.sites.item.termStores.item.sets.item.terms.item.relations.item collection
     * @param id Unique identifier of the item
