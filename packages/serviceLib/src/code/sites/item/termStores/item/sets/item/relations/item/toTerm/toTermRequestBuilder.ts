...
/** Builds and executes requests for operations under /sites/{site-id}/termStores/{store-id}/sets/{set-id}/relations/{relation-id}/toTerm  */
export class ToTermRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/relations/{relation_id}/toTerm{?select,expand}";
