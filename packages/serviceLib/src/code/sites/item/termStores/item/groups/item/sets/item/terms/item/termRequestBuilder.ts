...
import {TermRequestBuilder as iac3295be50185806fe4cbe30c5390c81a7839d8bf9c5917d3ec3ab35586fcae9} from './children/item/';
...
export class TermRequestBuilder {
     ...
     */
    public childrenById(id: string) : iac3295be50185806fe4cbe30c5390c81a7839d8bf9c5917d3ec3ab35586fcae9 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term_id1"] = id
        return new iac3295be50185806fe4cbe30c5390c81a7839d8bf9c5917d3ec3ab35586fcae9(urlTplParams, this.requestAdapter);
    };
    /**
