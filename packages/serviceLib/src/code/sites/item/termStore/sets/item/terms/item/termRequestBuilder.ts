...
import {TermRequestBuilder as ic56c0ce64a1b99f8fa71a4f8882115922b717f05aa7afe003a30ef8a35d44bf9} from './children/item/';
...
export class TermRequestBuilder {
     ...
     */
    public childrenById(id: string) : ic56c0ce64a1b99f8fa71a4f8882115922b717f05aa7afe003a30ef8a35d44bf9 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term_id1"] = id
        return new ic56c0ce64a1b99f8fa71a4f8882115922b717f05aa7afe003a30ef8a35d44bf9(urlTplParams, this.requestAdapter);
    };
    /**
