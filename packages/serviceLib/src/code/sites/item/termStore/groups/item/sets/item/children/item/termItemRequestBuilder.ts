...
import {TermItemRequestBuilder as ifb71ddf28c149a27aeafa024e6e9824df0b25af82f17c476e9002742c2add731} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : ifb71ddf28c149a27aeafa024e6e9824df0b25af82f17c476e9002742c2add731 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term_id1"] = id
        return new ifb71ddf28c149a27aeafa024e6e9824df0b25af82f17c476e9002742c2add731(urlTplParams, this.requestAdapter);
    };
    /**
