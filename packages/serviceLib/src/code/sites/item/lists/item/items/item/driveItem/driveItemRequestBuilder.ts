...
/** Builds and executes requests for operations under /sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem  */
export class DriveItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/items/{listItem_id}/driveItem{?select,expand}";
