...
export class HealthOverviewsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as HealthOverviewsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as HealthOverviewsResponse).value = n.getCollectionOfObjectValues<ServiceHealth>(ServiceHealth); }],
        ]);
    };
    /**
