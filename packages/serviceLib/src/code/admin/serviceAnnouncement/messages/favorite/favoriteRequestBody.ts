...
export class FavoriteRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["messageIds", (o, n) => { (o as unknown as FavoriteRequestBody).messageIds = n.getCollectionOfPrimitiveValues<string>(); }],
        ]);
    };
    /**
