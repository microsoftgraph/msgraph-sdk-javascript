...
export class FavoriteRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: FavoriteRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
     ...
     */
    public post(body: FavoriteRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<FavoriteResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
