...
export class CheckMemberObjectsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/permissionGrants/{resourceSpecificPermissionGrant_id}/microsoft.graph.checkMemberObjects";
     ...
     */
    public createPostRequestInformation(body: CheckMemberObjectsRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
     ...
     */
    public post(body: CheckMemberObjectsRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CheckMemberObjectsResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
