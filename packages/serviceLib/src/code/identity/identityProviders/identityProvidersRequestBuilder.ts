...
export class IdentityProvidersRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: IdentityProviderBase | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
     ...
     */
    public post(body: IdentityProviderBase | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<IdentityProviderBase | undefined> {
        if(!body) throw new Error("body cannot be undefined");
