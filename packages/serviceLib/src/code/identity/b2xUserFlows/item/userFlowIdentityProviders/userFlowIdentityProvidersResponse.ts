...
export class UserFlowIdentityProvidersResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as UserFlowIdentityProvidersResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as UserFlowIdentityProvidersResponse).value = n.getCollectionOfObjectValues<IdentityProviderBase>(IdentityProviderBase); }],
        ]);
    };
    /**
