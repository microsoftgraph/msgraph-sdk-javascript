...
export class UserFlowAttributesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as UserFlowAttributesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as UserFlowAttributesResponse).value = n.getCollectionOfObjectValues<IdentityUserFlowAttribute>(IdentityUserFlowAttribute); }],
        ]);
    };
    /**
