...
export class PrimaryChannelRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.primaryChannel.members.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.primaryChannel.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.primaryChannel.tabs.item collection
     * @param id Unique identifier of the item
