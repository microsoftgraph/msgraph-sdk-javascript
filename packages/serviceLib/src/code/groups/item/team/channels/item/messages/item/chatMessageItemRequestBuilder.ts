...
import {ChatMessageItemRequestBuilder as id386b29282ab8b93ed1d08914180214bdfc1b869e71205dbd124e1dc55e728ac} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/team/channels/{channel_id}/messages/{chatMessage_id}{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.channels.item.messages.item.hostedContents.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.channels.item.messages.item.replies.item collection
     * @param id Unique identifier of the item
     * @returns a chatMessageItemRequestBuilder
     */
    public repliesById(id: string) : id386b29282ab8b93ed1d08914180214bdfc1b869e71205dbd124e1dc55e728ac {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage_id1"] = id
        return new id386b29282ab8b93ed1d08914180214bdfc1b869e71205dbd124e1dc55e728ac(urlTplParams, this.requestAdapter);
    };
}
