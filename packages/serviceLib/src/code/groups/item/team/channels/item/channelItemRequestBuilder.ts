...
export class ChannelItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.channels.item.members.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.channels.item.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.team.channels.item.tabs.item collection
     * @param id Unique identifier of the item
