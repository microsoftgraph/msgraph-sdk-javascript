...
import {SectionGroupItemRequestBuilder as id54327b5cd729f8914eb4b109fa944442634ecdea995f088c2346b87b4f9f236} from './sectionGroups/item/sectionGroupItemRequestBuilder';
...
export class SectionGroupItemRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : id54327b5cd729f8914eb4b109fa944442634ecdea995f088c2346b87b4f9f236 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup_id1"] = id
        return new id54327b5cd729f8914eb4b109fa944442634ecdea995f088c2346b87b4f9f236(urlTplParams, this.requestAdapter);
    };
    /**
