...
/** Builds and executes requests for operations under /groups/{group-id}/onenote/sections/{onenoteSection-id}/pages/{onenotePage-id}/content  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}/content";
