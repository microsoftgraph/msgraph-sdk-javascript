...
export class ListItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/listItem{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.drives.item.bundles.item.listItem.versions.item collection
