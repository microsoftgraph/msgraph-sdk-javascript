...
export class ListItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/root/listItem{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.drives.item.root.listItem.versions.item collection
