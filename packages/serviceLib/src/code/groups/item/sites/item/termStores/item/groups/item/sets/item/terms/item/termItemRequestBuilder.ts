...
import {TermItemRequestBuilder as i22e6f7004741207f44eb6baad1b359d504b4d30247a36dcfb7412393432af57a} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.sites.item.termStores.item.groups.item.sets.item.terms.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a termItemRequestBuilder
     */
    public childrenById(id: string) : i22e6f7004741207f44eb6baad1b359d504b4d30247a36dcfb7412393432af57a {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term_id1"] = id
        return new i22e6f7004741207f44eb6baad1b359d504b4d30247a36dcfb7412393432af57a(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/groups/{group_id1}/sets/{set_id}/terms/{term_id}{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.sites.item.termStores.item.groups.item.sets.item.terms.item.relations.item collection
     * @param id Unique identifier of the item
