...
import {Group, GroupCollectionResponse} from '../../../../../../../models/microsoft/graph/termStore/';
...
export class GroupsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/groups{?top,skip,search,filter,count,orderby,select,expand}";
