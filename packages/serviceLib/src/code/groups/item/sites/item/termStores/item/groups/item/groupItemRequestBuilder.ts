...
export class GroupItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/groups/{group_id1}{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.sites.item.termStores.item.groups.item.sets.item collection
