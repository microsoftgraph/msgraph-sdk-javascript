...
import {TermItemRequestBuilder as iada1473c0f82b2f570a3d3bf52babad02b738ed46613aa93bf6223fc3954dd20} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.sites.item.termStores.item.sets.item.children.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a termItemRequestBuilder
     */
    public childrenById(id: string) : iada1473c0f82b2f570a3d3bf52babad02b738ed46613aa93bf6223fc3954dd20 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term_id1"] = id
        return new iada1473c0f82b2f570a3d3bf52babad02b738ed46613aa93bf6223fc3954dd20(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/children/{term_id}{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.groups.item.sites.item.termStores.item.sets.item.children.item.relations.item collection
     * @param id Unique identifier of the item
