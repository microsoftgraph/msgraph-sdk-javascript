...
/** Builds and executes requests for operations under /groups/{group-id}/calendarView/{event-id}/calendar/$ref  */
export class RefRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}/calendar/$ref";
