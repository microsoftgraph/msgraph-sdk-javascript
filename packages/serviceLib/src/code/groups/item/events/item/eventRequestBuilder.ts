...
import {EventRequestBuilder as i906b34c1b6f1817b00b4fafaac91d423b7f778111ff3c9b939f3ca9d4c45823d} from './instances/item/';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : i906b34c1b6f1817b00b4fafaac91d423b7f778111ff3c9b939f3ca9d4c45823d {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new i906b34c1b6f1817b00b4fafaac91d423b7f778111ff3c9b939f3ca9d4c45823d(urlTplParams, this.requestAdapter);
    };
    /**
