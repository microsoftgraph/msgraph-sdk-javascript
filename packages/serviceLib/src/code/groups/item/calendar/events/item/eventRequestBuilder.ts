...
import {EventRequestBuilder as i7827ed413d84f985629b8deeed2f21540fe8cbae72a9a59cfaa0013ff4413190} from './instances/item/';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : i7827ed413d84f985629b8deeed2f21540fe8cbae72a9a59cfaa0013ff4413190 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new i7827ed413d84f985629b8deeed2f21540fe8cbae72a9a59cfaa0013ff4413190(urlTplParams, this.requestAdapter);
    };
    /**
