...
import {EventRequestBuilder as ibf870e1026a7871a6daa3c7f463af2c7d6f023fbf66112fa97d551dc84978f18} from './instances/item/';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : ibf870e1026a7871a6daa3c7f463af2c7d6f023fbf66112fa97d551dc84978f18 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new ibf870e1026a7871a6daa3c7f463af2c7d6f023fbf66112fa97d551dc84978f18(urlTplParams, this.requestAdapter);
    };
    /**
