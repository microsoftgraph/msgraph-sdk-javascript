...
/** Builds and executes requests for operations under /groupSettingTemplates/{groupSettingTemplate-id}/microsoft.graph.restore  */
export class RestoreRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/groupSettingTemplates/{groupSettingTemplate_id}/microsoft.graph.restore";
     ...
     */
    public post(h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DirectoryObject | undefined> {
