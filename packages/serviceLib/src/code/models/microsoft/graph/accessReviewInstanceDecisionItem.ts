...
export class AccessReviewInstanceDecisionItem extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["appliedBy", (o, n) => { (o as unknown as AccessReviewInstanceDecisionItem).appliedBy = n.getObjectValue<UserIdentity>(createUserIdentityFromDiscriminatorValue); }],
            ...
            ["principal", (o, n) => { (o as unknown as AccessReviewInstanceDecisionItem).principal = n.getObjectValue<Identity>(createIdentityFromDiscriminatorValue); }],
            ...
            ["resource", (o, n) => { (o as unknown as AccessReviewInstanceDecisionItem).resource = n.getObjectValue<AccessReviewInstanceDecisionItemResource>(createAccessReviewInstanceDecisionItemResourceFromDiscriminatorValue); }],
            ["resourceLink", (o, n) => { (o as unknown as AccessReviewInstanceDecisionItem).resourceLink = n.getStringValue(); }],
            ["reviewedBy", (o, n) => { (o as unknown as AccessReviewInstanceDecisionItem).reviewedBy = n.getObjectValue<UserIdentity>(createUserIdentityFromDiscriminatorValue); }],
