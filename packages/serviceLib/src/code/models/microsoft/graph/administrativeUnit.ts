...
export class AdministrativeUnit extends DirectoryObject implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["extensions", (o, n) => { (o as unknown as AdministrativeUnit).extensions = n.getCollectionOfObjectValues<Extension>(createExtensionFromDiscriminatorValue); }],
            ["members", (o, n) => { (o as unknown as AdministrativeUnit).members = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); }],
            ["scopedRoleMembers", (o, n) => { (o as unknown as AdministrativeUnit).scopedRoleMembers = n.getCollectionOfObjectValues<ScopedRoleMembership>(createScopedRoleMembershipFromDiscriminatorValue); }],
