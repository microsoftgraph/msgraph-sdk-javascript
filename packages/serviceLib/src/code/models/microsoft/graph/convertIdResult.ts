...
export class ConvertIdResult implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["errorDetails", (o, n) => { (o as unknown as ConvertIdResult).errorDetails = n.getObjectValue<GenericError>(GenericError); }],
