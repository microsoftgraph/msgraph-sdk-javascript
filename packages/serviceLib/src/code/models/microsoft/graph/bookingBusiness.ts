...
export class BookingBusiness extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["address", (o, n) => { (o as unknown as BookingBusiness).address = n.getObjectValue<PhysicalAddress>(createPhysicalAddressFromDiscriminatorValue); }],
            ["appointments", (o, n) => { (o as unknown as BookingBusiness).appointments = n.getCollectionOfObjectValues<BookingAppointment>(createBookingAppointmentFromDiscriminatorValue); }],
            ["businessHours", (o, n) => { (o as unknown as BookingBusiness).businessHours = n.getCollectionOfObjectValues<BookingWorkHours>(createBookingWorkHoursFromDiscriminatorValue); }],
            ["businessType", (o, n) => { (o as unknown as BookingBusiness).businessType = n.getStringValue(); }],
            ["calendarView", (o, n) => { (o as unknown as BookingBusiness).calendarView = n.getCollectionOfObjectValues<BookingAppointment>(createBookingAppointmentFromDiscriminatorValue); }],
            ["customers", (o, n) => { (o as unknown as BookingBusiness).customers = n.getCollectionOfObjectValues<BookingCustomerBase>(createBookingCustomerBaseFromDiscriminatorValue); }],
            ["customQuestions", (o, n) => { (o as unknown as BookingBusiness).customQuestions = n.getCollectionOfObjectValues<BookingCustomQuestion>(createBookingCustomQuestionFromDiscriminatorValue); }],
            ...
            ["schedulingPolicy", (o, n) => { (o as unknown as BookingBusiness).schedulingPolicy = n.getObjectValue<BookingSchedulingPolicy>(createBookingSchedulingPolicyFromDiscriminatorValue); }],
            ["services", (o, n) => { (o as unknown as BookingBusiness).services = n.getCollectionOfObjectValues<BookingService>(createBookingServiceFromDiscriminatorValue); }],
            ["staffMembers", (o, n) => { (o as unknown as BookingBusiness).staffMembers = n.getCollectionOfObjectValues<BookingStaffMemberBase>(createBookingStaffMemberBaseFromDiscriminatorValue); }],
