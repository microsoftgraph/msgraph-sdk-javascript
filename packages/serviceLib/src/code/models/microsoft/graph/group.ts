...
export class Group extends DirectoryObject implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["acceptedSenders", (o, n) => { (o as unknown as Group).acceptedSenders = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); }],
            ["allowExternalSenders", (o, n) => { (o as unknown as Group).allowExternalSenders = n.getBooleanValue(); }],
            ["appRoleAssignments", (o, n) => { (o as unknown as Group).appRoleAssignments = n.getCollectionOfObjectValues<AppRoleAssignment>(createAppRoleAssignmentFromDiscriminatorValue); }],
            ["assignedLabels", (o, n) => { (o as unknown as Group).assignedLabels = n.getCollectionOfObjectValues<AssignedLabel>(createAssignedLabelFromDiscriminatorValue); }],
            ["assignedLicenses", (o, n) => { (o as unknown as Group).assignedLicenses = n.getCollectionOfObjectValues<AssignedLicense>(createAssignedLicenseFromDiscriminatorValue); }],
            ["autoSubscribeNewMembers", (o, n) => { (o as unknown as Group).autoSubscribeNewMembers = n.getBooleanValue(); }],
            ["calendar", (o, n) => { (o as unknown as Group).calendar = n.getObjectValue<Calendar>(createCalendarFromDiscriminatorValue); }],
            ["calendarView", (o, n) => { (o as unknown as Group).calendarView = n.getCollectionOfObjectValues<Event>(createEventFromDiscriminatorValue); }],
            ["classification", (o, n) => { (o as unknown as Group).classification = n.getStringValue(); }],
            ["conversations", (o, n) => { (o as unknown as Group).conversations = n.getCollectionOfObjectValues<Conversation>(createConversationFromDiscriminatorValue); }],
            ["createdDateTime", (o, n) => { (o as unknown as Group).createdDateTime = n.getDateValue(); }],
            ["createdOnBehalfOf", (o, n) => { (o as unknown as Group).createdOnBehalfOf = n.getObjectValue<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); }],
            ...
            ["drive", (o, n) => { (o as unknown as Group).drive = n.getObjectValue<Drive>(createDriveFromDiscriminatorValue); }],
            ["drives", (o, n) => { (o as unknown as Group).drives = n.getCollectionOfObjectValues<Drive>(createDriveFromDiscriminatorValue); }],
            ["events", (o, n) => { (o as unknown as Group).events = n.getCollectionOfObjectValues<Event>(createEventFromDiscriminatorValue); }],
            ["expirationDateTime", (o, n) => { (o as unknown as Group).expirationDateTime = n.getDateValue(); }],
            ["extensions", (o, n) => { (o as unknown as Group).extensions = n.getCollectionOfObjectValues<Extension>(createExtensionFromDiscriminatorValue); }],
            ["groupLifecyclePolicies", (o, n) => { (o as unknown as Group).groupLifecyclePolicies = n.getCollectionOfObjectValues<GroupLifecyclePolicy>(createGroupLifecyclePolicyFromDiscriminatorValue); }],
            ...
            ["licenseProcessingState", (o, n) => { (o as unknown as Group).licenseProcessingState = n.getObjectValue<LicenseProcessingState>(createLicenseProcessingStateFromDiscriminatorValue); }],
            ...
            ["memberOf", (o, n) => { (o as unknown as Group).memberOf = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); }],
            ["members", (o, n) => { (o as unknown as Group).members = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); }],
            ...
            ["membersWithLicenseErrors", (o, n) => { (o as unknown as Group).membersWithLicenseErrors = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); }],
            ["onenote", (o, n) => { (o as unknown as Group).onenote = n.getObjectValue<Onenote>(createOnenoteFromDiscriminatorValue); }],
            ...
            ["onPremisesProvisioningErrors", (o, n) => { (o as unknown as Group).onPremisesProvisioningErrors = n.getCollectionOfObjectValues<OnPremisesProvisioningError>(createOnPremisesProvisioningErrorFromDiscriminatorValue); }],
            ...
            ["owners", (o, n) => { (o as unknown as Group).owners = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); }],
            ["permissionGrants", (o, n) => { (o as unknown as Group).permissionGrants = n.getCollectionOfObjectValues<ResourceSpecificPermissionGrant>(createResourceSpecificPermissionGrantFromDiscriminatorValue); }],
            ["photo", (o, n) => { (o as unknown as Group).photo = n.getObjectValue<ProfilePhoto>(createProfilePhotoFromDiscriminatorValue); }],
            ["photos", (o, n) => { (o as unknown as Group).photos = n.getCollectionOfObjectValues<ProfilePhoto>(createProfilePhotoFromDiscriminatorValue); }],
            ["planner", (o, n) => { (o as unknown as Group).planner = n.getObjectValue<PlannerGroup>(createPlannerGroupFromDiscriminatorValue); }],
            ...
            ["rejectedSenders", (o, n) => { (o as unknown as Group).rejectedSenders = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); }],
            ...
            ["settings", (o, n) => { (o as unknown as Group).settings = n.getCollectionOfObjectValues<GroupSetting>(createGroupSettingFromDiscriminatorValue); }],
            ["sites", (o, n) => { (o as unknown as Group).sites = n.getCollectionOfObjectValues<Site>(createSiteFromDiscriminatorValue); }],
            ["team", (o, n) => { (o as unknown as Group).team = n.getObjectValue<Team>(createTeamFromDiscriminatorValue); }],
            ["theme", (o, n) => { (o as unknown as Group).theme = n.getStringValue(); }],
            ["threads", (o, n) => { (o as unknown as Group).threads = n.getCollectionOfObjectValues<ConversationThread>(createConversationThreadFromDiscriminatorValue); }],
            ["transitiveMemberOf", (o, n) => { (o as unknown as Group).transitiveMemberOf = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); }],
            ["transitiveMembers", (o, n) => { (o as unknown as Group).transitiveMembers = n.getCollectionOfObjectValues<DirectoryObject>(createDirectoryObjectFromDiscriminatorValue); }],
