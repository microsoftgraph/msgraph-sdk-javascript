...
export class MeetingTimeSuggestionsResult implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ...
            ["meetingTimeSuggestions", (o, n) => { (o as unknown as MeetingTimeSuggestionsResult).meetingTimeSuggestions = n.getCollectionOfObjectValues<MeetingTimeSuggestion>(createMeetingTimeSuggestionFromDiscriminatorValue); }],
        ]);
    };
    /**
