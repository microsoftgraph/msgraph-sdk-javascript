import {Attachment, Extension, FollowupFlag, Importance, InferenceClassificationType, InternetMessageHeader, ItemBody, MultiValueLegacyExtendedProperty, OutlookItem, Recipient, SingleValueLegacyExtendedProperty} from './index';
