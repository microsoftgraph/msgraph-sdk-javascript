import {NotebookLinks, OnenoteEntityHierarchyModel, OnenoteSection, OnenoteUserRole, SectionGroup} from './index';
...
export class Notebook extends OnenoteEntityHierarchyModel implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["links", (o, n) => { (o as unknown as Notebook).links = n.getObjectValue<NotebookLinks>(NotebookLinks); }],
            ["sectionGroups", (o, n) => { (o as unknown as Notebook).sectionGroups = n.getCollectionOfObjectValues<SectionGroup>(SectionGroup); }],
