...
export class DeviceCompliancePolicyAssignmentCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeviceCompliancePolicyAssignmentCollectionResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeviceCompliancePolicyAssignmentCollectionResponse).value = n.getCollectionOfObjectValues<DeviceCompliancePolicyAssignment>(createDeviceCompliancePolicyAssignmentFromDiscriminatorValue); }],
        ]);
    };
    /**
