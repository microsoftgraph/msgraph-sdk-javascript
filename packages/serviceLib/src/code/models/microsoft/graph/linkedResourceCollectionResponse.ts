...
export class LinkedResourceCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as LinkedResourceCollectionResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as LinkedResourceCollectionResponse).value = n.getCollectionOfObjectValues<LinkedResource>(createLinkedResourceFromDiscriminatorValue); }],
        ]);
    };
    /**
