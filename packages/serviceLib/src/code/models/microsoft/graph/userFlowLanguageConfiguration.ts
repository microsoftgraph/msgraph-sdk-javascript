...
export class UserFlowLanguageConfiguration extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ["defaultPages", (o, n) => { (o as unknown as UserFlowLanguageConfiguration).defaultPages = n.getCollectionOfObjectValues<UserFlowLanguagePage>(createUserFlowLanguagePageFromDiscriminatorValue); }],
            ...
            ["overridesPages", (o, n) => { (o as unknown as UserFlowLanguageConfiguration).overridesPages = n.getCollectionOfObjectValues<UserFlowLanguagePage>(createUserFlowLanguagePageFromDiscriminatorValue); }],
        ]);
    };
    /**
