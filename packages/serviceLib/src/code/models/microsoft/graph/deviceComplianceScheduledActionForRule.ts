...
export class DeviceComplianceScheduledActionForRule extends Entity implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["scheduledActionConfigurations", (o, n) => { (o as unknown as DeviceComplianceScheduledActionForRule).scheduledActionConfigurations = n.getCollectionOfObjectValues<DeviceComplianceActionItem>(createDeviceComplianceActionItemFromDiscriminatorValue); }],
        ]);
    };
    /**
