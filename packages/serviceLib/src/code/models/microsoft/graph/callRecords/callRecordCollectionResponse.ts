...
export class CallRecordCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as CallRecordCollectionResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as CallRecordCollectionResponse).value = n.getCollectionOfObjectValues<CallRecord>(createCallRecordFromDiscriminatorValue); }],
        ]);
    };
    /**
