...
export class TeamsAppCollectionResponse implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TeamsAppCollectionResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TeamsAppCollectionResponse).value = n.getCollectionOfObjectValues<TeamsApp>(createTeamsAppFromDiscriminatorValue); }],
        ]);
    };
    /**
