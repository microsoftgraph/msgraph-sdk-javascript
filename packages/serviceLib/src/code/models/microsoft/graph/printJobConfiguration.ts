import {IntegerRange, PrintColorMode, PrintDuplexMode, PrinterFeedOrientation, PrintFinishing, PrintMargin, PrintMultipageLayout, PrintOrientation, PrintQuality, PrintScaling} from './index';
