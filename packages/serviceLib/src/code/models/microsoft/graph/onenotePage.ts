...
export class OnenotePage extends OnenoteEntitySchemaObjectModel implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([...super.getFieldDeserializers<T>(),
            ...
            ["links", (o, n) => { (o as unknown as OnenotePage).links = n.getObjectValue<PageLinks>(createPageLinksFromDiscriminatorValue); }],
            ["order", (o, n) => { (o as unknown as OnenotePage).order = n.getNumberValue(); }],
            ["parentNotebook", (o, n) => { (o as unknown as OnenotePage).parentNotebook = n.getObjectValue<Notebook>(createNotebookFromDiscriminatorValue); }],
            ["parentSection", (o, n) => { (o as unknown as OnenotePage).parentSection = n.getObjectValue<OnenoteSection>(createOnenoteSectionFromDiscriminatorValue); }],
