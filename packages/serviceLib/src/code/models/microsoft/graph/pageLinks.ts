...
export class PageLinks implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["oneNoteClientUrl", (o, n) => { (o as unknown as PageLinks).oneNoteClientUrl = n.getObjectValue<ExternalLink>(createExternalLinkFromDiscriminatorValue); }],
            ["oneNoteWebUrl", (o, n) => { (o as unknown as PageLinks).oneNoteWebUrl = n.getObjectValue<ExternalLink>(createExternalLinkFromDiscriminatorValue); }],
        ]);
    };
    /**
