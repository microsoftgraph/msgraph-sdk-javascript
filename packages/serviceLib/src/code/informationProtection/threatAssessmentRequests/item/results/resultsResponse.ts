...
export class ResultsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ResultsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ResultsResponse).value = n.getCollectionOfObjectValues<ThreatAssessmentResult>(ThreatAssessmentResult); }],
        ]);
    };
    /**
