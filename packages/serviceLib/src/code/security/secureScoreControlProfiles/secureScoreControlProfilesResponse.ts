...
export class SecureScoreControlProfilesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SecureScoreControlProfilesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SecureScoreControlProfilesResponse).value = n.getCollectionOfObjectValues<SecureScoreControlProfile>(SecureScoreControlProfile); }],
        ]);
    };
    /**
