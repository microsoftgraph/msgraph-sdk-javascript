...
export class AlertsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AlertsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AlertsResponse).value = n.getCollectionOfObjectValues<Alert>(Alert); }],
        ]);
    };
    /**
