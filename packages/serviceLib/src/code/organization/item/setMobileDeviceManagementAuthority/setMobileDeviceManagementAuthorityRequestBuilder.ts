...
export class SetMobileDeviceManagementAuthorityRequestBuilder {
     ...
     */
    public post(h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<number | undefined> {
