...
export class OrganizationItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.organization.item.certificateBasedAuthConfiguration.item collection
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: Organization | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
    ...
    /**
     * Gets an item from the MicrosoftGraph.organization.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Organization | undefined> {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: Organization | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
