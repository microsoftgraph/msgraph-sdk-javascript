...
export class DirectoryRoleTemplatesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DirectoryRoleTemplatesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DirectoryRoleTemplatesResponse).value = n.getCollectionOfObjectValues<DirectoryRoleTemplate>(DirectoryRoleTemplate); }],
        ]);
    };
    /**
