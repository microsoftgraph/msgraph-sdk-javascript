...
/** Builds and executes requests for operations under /shares/{sharedDriveItem-id}/listItem/driveItem  */
export class DriveItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/listItem/driveItem{?select,expand}";
