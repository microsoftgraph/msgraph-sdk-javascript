...
export class ConnectionsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ConnectionsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ConnectionsResponse).value = n.getCollectionOfObjectValues<ExternalConnection>(ExternalConnection); }],
        ]);
    };
    /**
