...
/** Builds and executes requests for operations under /drives/{drive-id}/special/{driveItem-id}/content  */
export class ContentRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}/content";
