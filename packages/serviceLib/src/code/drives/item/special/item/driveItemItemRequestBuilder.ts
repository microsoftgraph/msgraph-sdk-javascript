...
import {DriveItemItemRequestBuilder as ib1f2daa1262ca52723412110a47e0ab69b6c39b89e430ce9b73e97f10eefee55} from './children/item/driveItemItemRequestBuilder';
...
export class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.item.special.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a driveItemItemRequestBuilder
     */
    public childrenById(id: string) : ib1f2daa1262ca52723412110a47e0ab69b6c39b89e430ce9b73e97f10eefee55 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem_id1"] = id
        return new ib1f2daa1262ca52723412110a47e0ab69b6c39b89e430ce9b73e97f10eefee55(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.item.special.item.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.item.special.item.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.item.special.item.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.item.special.item.versions.item collection
     * @param id Unique identifier of the item
