...
import {DriveItemItemRequestBuilder as i3dbeea289c2f55a2da44d07da2775cf9d5a4eb6e245eb3ec89cb549cb8914334} from './children/item/driveItemItemRequestBuilder';
...
export class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.item.bundles.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a driveItemItemRequestBuilder
     */
    public childrenById(id: string) : i3dbeea289c2f55a2da44d07da2775cf9d5a4eb6e245eb3ec89cb549cb8914334 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem_id1"] = id
        return new i3dbeea289c2f55a2da44d07da2775cf9d5a4eb6e245eb3ec89cb549cb8914334(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.item.bundles.item.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.item.bundles.item.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.item.bundles.item.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.drives.item.bundles.item.versions.item collection
     * @param id Unique identifier of the item
