...
/** Builds and executes requests for operations under /drives/{drive-id}/list/items/{listItem-id}/driveItem/$ref  */
export class RefRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive_id}/list/items/{listItem_id}/driveItem/$ref";
