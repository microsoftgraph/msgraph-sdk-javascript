...
/** Builds and executes requests for operations under /drives/{drive-id}/list/contentTypes/{contentType-id}/microsoft.graph.publish  */
export class PublishRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive_id}/list/contentTypes/{contentType_id}/microsoft.graph.publish";
