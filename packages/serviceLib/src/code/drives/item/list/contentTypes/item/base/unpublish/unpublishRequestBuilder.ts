...
/** Builds and executes requests for operations under /drives/{drive-id}/list/contentTypes/{contentType-id}/base/microsoft.graph.unpublish  */
export class UnpublishRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/drives/{drive_id}/list/contentTypes/{contentType_id}/base/microsoft.graph.unpublish";
