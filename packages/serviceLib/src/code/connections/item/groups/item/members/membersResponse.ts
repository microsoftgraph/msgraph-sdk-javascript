import {Identity} from '../../../../../models/microsoft/graph/externalConnectors/';
...
export class MembersResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ...
            ["value", (o, n) => { (o as unknown as MembersResponse).value = n.getCollectionOfObjectValues<Identity>(Identity); }],
        ]);
    };
    /**
