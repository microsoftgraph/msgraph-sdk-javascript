...
export class DailyPrintUsageByPrinterResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DailyPrintUsageByPrinterResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DailyPrintUsageByPrinterResponse).value = n.getCollectionOfObjectValues<PrintUsageByPrinter>(PrintUsageByPrinter); }],
        ]);
    };
    /**
