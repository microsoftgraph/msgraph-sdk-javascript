...
export class MonthlyPrintUsageByPrinterResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as MonthlyPrintUsageByPrinterResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as MonthlyPrintUsageByPrinterResponse).value = n.getCollectionOfObjectValues<PrintUsageByPrinter>(PrintUsageByPrinter); }],
        ]);
    };
    /**
