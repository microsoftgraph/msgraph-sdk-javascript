...
export class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder {
     ...
     */
    public get(h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetMailboxUsageQuotaStatusMailboxCountsWithPeriodResponse | undefined> {
