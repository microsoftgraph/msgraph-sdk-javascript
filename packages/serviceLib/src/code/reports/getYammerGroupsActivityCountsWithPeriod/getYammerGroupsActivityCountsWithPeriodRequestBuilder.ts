...
export class GetYammerGroupsActivityCountsWithPeriodRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter, period?: string | undefined) {
        ...
        this.urlTemplate = "{+baseurl}/reports/microsoft.graph.getYammerGroupsActivityCounts(period='{period}')";
