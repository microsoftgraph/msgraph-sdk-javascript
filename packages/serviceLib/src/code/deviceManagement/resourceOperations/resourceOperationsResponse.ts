...
export class ResourceOperationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ResourceOperationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ResourceOperationsResponse).value = n.getCollectionOfObjectValues<ResourceOperation>(ResourceOperation); }],
        ]);
    };
    /**
