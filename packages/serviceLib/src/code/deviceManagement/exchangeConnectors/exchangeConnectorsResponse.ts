...
export class ExchangeConnectorsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ExchangeConnectorsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ExchangeConnectorsResponse).value = n.getCollectionOfObjectValues<DeviceManagementExchangeConnector>(DeviceManagementExchangeConnector); }],
        ]);
    };
    /**
