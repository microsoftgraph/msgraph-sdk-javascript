...
export class DeviceCompliancePolicySettingStateSummariesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeviceCompliancePolicySettingStateSummariesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeviceCompliancePolicySettingStateSummariesResponse).value = n.getCollectionOfObjectValues<DeviceCompliancePolicySettingStateSummary>(DeviceCompliancePolicySettingStateSummary); }],
        ]);
    };
    /**
