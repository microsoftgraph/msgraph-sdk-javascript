...
import {DeviceComplianceSettingStateRequestBuilder} from './deviceComplianceSettingStates/item/';
...
export class DeviceCompliancePolicySettingStateSummaryRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: DeviceCompliancePolicySettingStateSummary | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
    ...
    public deviceComplianceSettingStatesById(id: string) : DeviceComplianceSettingStateRequestBuilder {
        ...
        return new DeviceComplianceSettingStateRequestBuilder(urlTplParams, this.requestAdapter);
    };
    /**
     * The summary states of compliance policy settings for this account.
     * @param h Request headers
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceCompliancePolicySettingStateSummary | undefined> {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: DeviceCompliancePolicySettingStateSummary | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
