...
export class GetPolicyNonComplianceMetadataRequestBuilder {
     ...
     */
    public post(body: GetPolicyNonComplianceMetadataRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ArrayBuffer | undefined> {
        if(!body) throw new Error("body cannot be undefined");
