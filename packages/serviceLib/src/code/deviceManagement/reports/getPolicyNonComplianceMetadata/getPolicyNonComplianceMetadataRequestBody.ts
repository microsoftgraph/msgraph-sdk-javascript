...
export class GetPolicyNonComplianceMetadataRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["filter", (o, n) => { (o as unknown as GetPolicyNonComplianceMetadataRequestBody).filter = n.getStringValue(); }],
            ["groupBy", (o, n) => { (o as unknown as GetPolicyNonComplianceMetadataRequestBody).groupBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["name", (o, n) => { (o as unknown as GetPolicyNonComplianceMetadataRequestBody).name = n.getStringValue(); }],
            ["orderBy", (o, n) => { (o as unknown as GetPolicyNonComplianceMetadataRequestBody).orderBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["search", (o, n) => { (o as unknown as GetPolicyNonComplianceMetadataRequestBody).search = n.getStringValue(); }],
            ["select", (o, n) => { (o as unknown as GetPolicyNonComplianceMetadataRequestBody).select = n.getCollectionOfPrimitiveValues<string>(); }],
            ["sessionId", (o, n) => { (o as unknown as GetPolicyNonComplianceMetadataRequestBody).sessionId = n.getStringValue(); }],
            ["skip", (o, n) => { (o as unknown as GetPolicyNonComplianceMetadataRequestBody).skip = n.getNumberValue(); }],
            ["top", (o, n) => { (o as unknown as GetPolicyNonComplianceMetadataRequestBody).top = n.getNumberValue(); }],
        ]);
    };
    /**
