...
export class GetPolicyNonComplianceSummaryReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["filter", (o, n) => { (o as unknown as GetPolicyNonComplianceSummaryReportRequestBody).filter = n.getStringValue(); }],
            ["groupBy", (o, n) => { (o as unknown as GetPolicyNonComplianceSummaryReportRequestBody).groupBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["name", (o, n) => { (o as unknown as GetPolicyNonComplianceSummaryReportRequestBody).name = n.getStringValue(); }],
            ["orderBy", (o, n) => { (o as unknown as GetPolicyNonComplianceSummaryReportRequestBody).orderBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["search", (o, n) => { (o as unknown as GetPolicyNonComplianceSummaryReportRequestBody).search = n.getStringValue(); }],
            ["select", (o, n) => { (o as unknown as GetPolicyNonComplianceSummaryReportRequestBody).select = n.getCollectionOfPrimitiveValues<string>(); }],
            ["sessionId", (o, n) => { (o as unknown as GetPolicyNonComplianceSummaryReportRequestBody).sessionId = n.getStringValue(); }],
            ["skip", (o, n) => { (o as unknown as GetPolicyNonComplianceSummaryReportRequestBody).skip = n.getNumberValue(); }],
            ["top", (o, n) => { (o as unknown as GetPolicyNonComplianceSummaryReportRequestBody).top = n.getNumberValue(); }],
        ]);
    };
    /**
