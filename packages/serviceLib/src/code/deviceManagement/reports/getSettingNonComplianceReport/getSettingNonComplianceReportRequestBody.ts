...
export class GetSettingNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["filter", (o, n) => { (o as unknown as GetSettingNonComplianceReportRequestBody).filter = n.getStringValue(); }],
            ["groupBy", (o, n) => { (o as unknown as GetSettingNonComplianceReportRequestBody).groupBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["name", (o, n) => { (o as unknown as GetSettingNonComplianceReportRequestBody).name = n.getStringValue(); }],
            ["orderBy", (o, n) => { (o as unknown as GetSettingNonComplianceReportRequestBody).orderBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["search", (o, n) => { (o as unknown as GetSettingNonComplianceReportRequestBody).search = n.getStringValue(); }],
            ["select", (o, n) => { (o as unknown as GetSettingNonComplianceReportRequestBody).select = n.getCollectionOfPrimitiveValues<string>(); }],
            ["sessionId", (o, n) => { (o as unknown as GetSettingNonComplianceReportRequestBody).sessionId = n.getStringValue(); }],
            ["skip", (o, n) => { (o as unknown as GetSettingNonComplianceReportRequestBody).skip = n.getNumberValue(); }],
            ["top", (o, n) => { (o as unknown as GetSettingNonComplianceReportRequestBody).top = n.getNumberValue(); }],
        ]);
    };
    /**
