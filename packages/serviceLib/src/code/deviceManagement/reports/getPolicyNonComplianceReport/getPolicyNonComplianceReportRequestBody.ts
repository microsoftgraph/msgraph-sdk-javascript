...
export class GetPolicyNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["filter", (o, n) => { (o as unknown as GetPolicyNonComplianceReportRequestBody).filter = n.getStringValue(); }],
            ["groupBy", (o, n) => { (o as unknown as GetPolicyNonComplianceReportRequestBody).groupBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["name", (o, n) => { (o as unknown as GetPolicyNonComplianceReportRequestBody).name = n.getStringValue(); }],
            ["orderBy", (o, n) => { (o as unknown as GetPolicyNonComplianceReportRequestBody).orderBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["search", (o, n) => { (o as unknown as GetPolicyNonComplianceReportRequestBody).search = n.getStringValue(); }],
            ["select", (o, n) => { (o as unknown as GetPolicyNonComplianceReportRequestBody).select = n.getCollectionOfPrimitiveValues<string>(); }],
            ["sessionId", (o, n) => { (o as unknown as GetPolicyNonComplianceReportRequestBody).sessionId = n.getStringValue(); }],
            ["skip", (o, n) => { (o as unknown as GetPolicyNonComplianceReportRequestBody).skip = n.getNumberValue(); }],
            ["top", (o, n) => { (o as unknown as GetPolicyNonComplianceReportRequestBody).top = n.getNumberValue(); }],
        ]);
    };
    /**
