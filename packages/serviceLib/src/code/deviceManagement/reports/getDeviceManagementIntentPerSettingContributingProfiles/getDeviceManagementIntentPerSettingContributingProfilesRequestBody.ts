...
export class GetDeviceManagementIntentPerSettingContributingProfilesRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["filter", (o, n) => { (o as unknown as GetDeviceManagementIntentPerSettingContributingProfilesRequestBody).filter = n.getStringValue(); }],
            ["groupBy", (o, n) => { (o as unknown as GetDeviceManagementIntentPerSettingContributingProfilesRequestBody).groupBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["name", (o, n) => { (o as unknown as GetDeviceManagementIntentPerSettingContributingProfilesRequestBody).name = n.getStringValue(); }],
            ["orderBy", (o, n) => { (o as unknown as GetDeviceManagementIntentPerSettingContributingProfilesRequestBody).orderBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["search", (o, n) => { (o as unknown as GetDeviceManagementIntentPerSettingContributingProfilesRequestBody).search = n.getStringValue(); }],
            ["select", (o, n) => { (o as unknown as GetDeviceManagementIntentPerSettingContributingProfilesRequestBody).select = n.getCollectionOfPrimitiveValues<string>(); }],
            ["sessionId", (o, n) => { (o as unknown as GetDeviceManagementIntentPerSettingContributingProfilesRequestBody).sessionId = n.getStringValue(); }],
            ["skip", (o, n) => { (o as unknown as GetDeviceManagementIntentPerSettingContributingProfilesRequestBody).skip = n.getNumberValue(); }],
            ["top", (o, n) => { (o as unknown as GetDeviceManagementIntentPerSettingContributingProfilesRequestBody).top = n.getNumberValue(); }],
        ]);
    };
    /**
