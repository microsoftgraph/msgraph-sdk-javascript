...
export class GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetDeviceManagementIntentPerSettingContributingProfilesRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
