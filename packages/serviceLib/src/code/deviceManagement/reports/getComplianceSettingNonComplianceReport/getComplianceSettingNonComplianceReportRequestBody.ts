...
export class GetComplianceSettingNonComplianceReportRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["filter", (o, n) => { (o as unknown as GetComplianceSettingNonComplianceReportRequestBody).filter = n.getStringValue(); }],
            ["groupBy", (o, n) => { (o as unknown as GetComplianceSettingNonComplianceReportRequestBody).groupBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["name", (o, n) => { (o as unknown as GetComplianceSettingNonComplianceReportRequestBody).name = n.getStringValue(); }],
            ["orderBy", (o, n) => { (o as unknown as GetComplianceSettingNonComplianceReportRequestBody).orderBy = n.getCollectionOfPrimitiveValues<string>(); }],
            ["search", (o, n) => { (o as unknown as GetComplianceSettingNonComplianceReportRequestBody).search = n.getStringValue(); }],
            ["select", (o, n) => { (o as unknown as GetComplianceSettingNonComplianceReportRequestBody).select = n.getCollectionOfPrimitiveValues<string>(); }],
            ["sessionId", (o, n) => { (o as unknown as GetComplianceSettingNonComplianceReportRequestBody).sessionId = n.getStringValue(); }],
            ["skip", (o, n) => { (o as unknown as GetComplianceSettingNonComplianceReportRequestBody).skip = n.getNumberValue(); }],
            ["top", (o, n) => { (o as unknown as GetComplianceSettingNonComplianceReportRequestBody).top = n.getNumberValue(); }],
        ]);
    };
    /**
