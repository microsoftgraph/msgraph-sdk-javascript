...
export class GetComplianceSettingNonComplianceReportRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: GetComplianceSettingNonComplianceReportRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined) : RequestInformation {
     ...
     */
    public post(body: GetComplianceSettingNonComplianceReportRequestBody | undefined, h?: Record<string, string> | undefined, o?: RequestOption[] | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetComplianceSettingNonComplianceReportResponse | undefined> {
        if(!body) throw new Error("body cannot be undefined");
