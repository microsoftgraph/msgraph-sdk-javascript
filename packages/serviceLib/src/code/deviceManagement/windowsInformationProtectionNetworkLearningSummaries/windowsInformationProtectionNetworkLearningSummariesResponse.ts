...
export class WindowsInformationProtectionNetworkLearningSummariesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as WindowsInformationProtectionNetworkLearningSummariesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as WindowsInformationProtectionNetworkLearningSummariesResponse).value = n.getCollectionOfObjectValues<WindowsInformationProtectionNetworkLearningSummary>(WindowsInformationProtectionNetworkLearningSummary); }],
        ]);
    };
    /**
