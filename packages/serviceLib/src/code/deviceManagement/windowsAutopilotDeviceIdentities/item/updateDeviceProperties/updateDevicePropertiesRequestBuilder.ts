...
export class UpdateDevicePropertiesRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: UpdateDevicePropertiesRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
     ...
     */
    public post(body: UpdateDevicePropertiesRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
