...
export class IosUpdateStatusesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as IosUpdateStatusesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as IosUpdateStatusesResponse).value = n.getCollectionOfObjectValues<IosUpdateDeviceStatus>(IosUpdateDeviceStatus); }],
        ]);
    };
    /**
