...
export class ScheduleActionsForRulesRequestBody implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["deviceComplianceScheduledActionForRules", (o, n) => { (o as unknown as ScheduleActionsForRulesRequestBody).deviceComplianceScheduledActionForRules = n.getCollectionOfObjectValues<DeviceComplianceScheduledActionForRule>(DeviceComplianceScheduledActionForRule); }],
        ]);
    };
    /**
