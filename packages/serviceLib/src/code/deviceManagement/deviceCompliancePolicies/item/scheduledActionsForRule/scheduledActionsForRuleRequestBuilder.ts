import {DeviceComplianceScheduledActionForRule, DeviceComplianceScheduledActionForRuleCollectionResponse} from '../../../../models/microsoft/graph/';
...
export class ScheduledActionsForRuleRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: DeviceComplianceScheduledActionForRule | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
    ...
    public get(q?: {
                    ...
                    skip?: number,
                    top?: number
                    } | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceComplianceScheduledActionForRuleCollectionResponse | undefined> {
     ...
     */
    public post(body: DeviceComplianceScheduledActionForRule | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceComplianceScheduledActionForRule | undefined> {
        if(!body) throw new Error("body cannot be undefined");
