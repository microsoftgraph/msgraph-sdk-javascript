...
export class DeviceCompliancePoliciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeviceCompliancePoliciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeviceCompliancePoliciesResponse).value = n.getCollectionOfObjectValues<DeviceCompliancePolicy>(DeviceCompliancePolicy); }],
        ]);
    };
    /**
