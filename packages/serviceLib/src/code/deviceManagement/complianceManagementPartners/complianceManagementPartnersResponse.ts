...
export class ComplianceManagementPartnersResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ComplianceManagementPartnersResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ComplianceManagementPartnersResponse).value = n.getCollectionOfObjectValues<ComplianceManagementPartner>(ComplianceManagementPartner); }],
        ]);
    };
    /**
