...
export class NotificationMessageTemplatesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as NotificationMessageTemplatesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as NotificationMessageTemplatesResponse).value = n.getCollectionOfObjectValues<NotificationMessageTemplate>(NotificationMessageTemplate); }],
        ]);
    };
    /**
