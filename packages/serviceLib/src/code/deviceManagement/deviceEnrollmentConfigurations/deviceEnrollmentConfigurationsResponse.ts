...
export class DeviceEnrollmentConfigurationsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeviceEnrollmentConfigurationsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeviceEnrollmentConfigurationsResponse).value = n.getCollectionOfObjectValues<DeviceEnrollmentConfiguration>(DeviceEnrollmentConfiguration); }],
        ]);
    };
    /**
