...
import {TermsAndConditionsAcceptanceStatusRequestBuilder} from './acceptanceStatuses/item/';
import {AssignmentsRequestBuilder} from './assignments/';
import {TermsAndConditionsAssignmentRequestBuilder} from './assignments/item/';
...
export class TermsAndConditionsRequestBuilder {
    ...
    public acceptanceStatusesById(id: string) : TermsAndConditionsAcceptanceStatusRequestBuilder {
        ...
        return new TermsAndConditionsAcceptanceStatusRequestBuilder(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    public assignmentsById(id: string) : TermsAndConditionsAssignmentRequestBuilder {
        ...
        return new TermsAndConditionsAssignmentRequestBuilder(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: TermsAndConditions | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TermsAndConditions | undefined> {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: TermsAndConditions | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
