...
export class TroubleshootingEventsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TroubleshootingEventsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TroubleshootingEventsResponse).value = n.getCollectionOfObjectValues<DeviceManagementTroubleshootingEvent>(DeviceManagementTroubleshootingEvent); }],
        ]);
    };
    /**
