...
export class ScopedRoleMembershipsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ScopedRoleMembershipsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ScopedRoleMembershipsResponse).value = n.getCollectionOfObjectValues<ScopedRoleMembership>(ScopedRoleMembership); }],
        ]);
    };
    /**
