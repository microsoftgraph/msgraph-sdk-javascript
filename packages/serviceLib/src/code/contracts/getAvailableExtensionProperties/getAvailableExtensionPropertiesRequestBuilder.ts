...
/** Builds and executes requests for operations under /contracts/microsoft.graph.getAvailableExtensionProperties  */
export class GetAvailableExtensionPropertiesRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/contracts/microsoft.graph.getAvailableExtensionProperties";
     ...
     */
    public createPostRequestInformation(body: GetAvailableExtensionPropertiesRequestBody | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
