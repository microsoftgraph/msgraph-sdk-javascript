...
/** Builds and executes requests for operations under /me/calendars/{calendar-id}/calendarView/{event-id}/calendar/$ref  */
export class RefRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/calendars/{calendar_id}/calendarView/{event_id}/calendar/$ref";
