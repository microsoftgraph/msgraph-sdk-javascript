...
/** Builds and executes requests for operations under /me/calendars/{calendar-id}/calendarView/{event-id}/instances  */
export class InstancesRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/calendars/{calendar_id}/calendarView/{event_id}/instances{?top,skip,filter,count,orderby,select}";
