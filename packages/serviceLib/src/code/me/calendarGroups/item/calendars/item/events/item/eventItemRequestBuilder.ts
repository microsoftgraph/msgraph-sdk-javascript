...
import {EventItemRequestBuilder as ib4a3cb6708de3750320ce0b663a2ff1d30e77dfbafc2d7e66c3074860d55a19e} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : ib4a3cb6708de3750320ce0b663a2ff1d30e77dfbafc2d7e66c3074860d55a19e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new ib4a3cb6708de3750320ce0b663a2ff1d30e77dfbafc2d7e66c3074860d55a19e(urlTplParams, this.requestAdapter);
    };
    /**
