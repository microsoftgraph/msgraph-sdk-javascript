...
export class ChannelItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/channels/{channel_id}{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.joinedTeams.item.channels.item.members.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.joinedTeams.item.channels.item.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.joinedTeams.item.channels.item.tabs.item collection
     * @param id Unique identifier of the item
