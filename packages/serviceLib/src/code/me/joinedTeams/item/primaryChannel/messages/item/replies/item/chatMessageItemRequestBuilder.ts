...
export class ChatMessageItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/primaryChannel/messages/{chatMessage_id}/replies/{chatMessage_id1}{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.joinedTeams.item.primaryChannel.messages.item.replies.item.hostedContents.item collection
