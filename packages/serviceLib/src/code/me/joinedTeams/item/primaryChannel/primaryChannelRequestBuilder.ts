...
export class PrimaryChannelRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/primaryChannel{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.joinedTeams.item.primaryChannel.members.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.joinedTeams.item.primaryChannel.messages.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.joinedTeams.item.primaryChannel.tabs.item collection
     * @param id Unique identifier of the item
