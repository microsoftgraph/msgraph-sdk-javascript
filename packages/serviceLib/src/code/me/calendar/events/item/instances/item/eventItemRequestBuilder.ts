...
export class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.events.item.instances.item.attachments.item collection
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/calendar/events/{event_id}/instances/{event_id1}{?select}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.events.item.instances.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.events.item.instances.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendar.events.item.instances.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
