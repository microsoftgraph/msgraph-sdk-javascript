...
import {EventRequestBuilder as ia7cd9c553ed3130aab3e6fde552d92bc505c2f01a7e8ff0fe330aae4c19d402a} from './instances/item/';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : ia7cd9c553ed3130aab3e6fde552d92bc505c2f01a7e8ff0fe330aae4c19d402a {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new ia7cd9c553ed3130aab3e6fde552d92bc505c2f01a7e8ff0fe330aae4c19d402a(urlTplParams, this.requestAdapter);
    };
    /**
