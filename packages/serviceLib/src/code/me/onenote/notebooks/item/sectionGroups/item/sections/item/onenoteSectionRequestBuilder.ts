...
export class OnenoteSectionRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.onenote.notebooks.item.sectionGroups.item.sections.item.pages.item collection
