...
/** Builds and executes requests for operations under /me/microsoft.graph.removeAllDevicesFromManagement  */
export class RemoveAllDevicesFromManagementRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/microsoft.graph.removeAllDevicesFromManagement";
