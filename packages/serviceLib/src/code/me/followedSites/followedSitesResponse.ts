...
export class FollowedSitesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as FollowedSitesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as FollowedSitesResponse).value = n.getCollectionOfObjectValues<Site>(Site); }],
        ]);
    };
    /**
