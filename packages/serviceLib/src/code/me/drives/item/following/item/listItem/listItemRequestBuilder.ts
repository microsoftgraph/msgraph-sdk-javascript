...
export class ListItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}/listItem{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.drives.item.following.item.listItem.versions.item collection
