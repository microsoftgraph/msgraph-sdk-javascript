...
export class AttendanceRecordsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AttendanceRecordsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AttendanceRecordsResponse).value = n.getCollectionOfObjectValues<AttendanceRecord>(AttendanceRecord); }],
        ]);
    };
    /**
