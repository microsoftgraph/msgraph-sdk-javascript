...
export class EventItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendarView.item.instances.item.attachments.item collection
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendarView.item.instances.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendarView.item.instances.item.multiValueExtendedProperties.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.me.calendarView.item.instances.item.singleValueExtendedProperties.item collection
     * @param id Unique identifier of the item
