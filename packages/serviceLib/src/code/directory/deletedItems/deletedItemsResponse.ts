...
export class DeletedItemsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as DeletedItemsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as DeletedItemsResponse).value = n.getCollectionOfObjectValues<DirectoryObject>(DirectoryObject); }],
        ]);
    };
    /**
