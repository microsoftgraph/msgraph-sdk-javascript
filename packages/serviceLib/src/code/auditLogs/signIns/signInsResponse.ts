...
export class SignInsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SignInsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SignInsResponse).value = n.getCollectionOfObjectValues<SignIn>(SignIn); }],
        ]);
    };
    /**
