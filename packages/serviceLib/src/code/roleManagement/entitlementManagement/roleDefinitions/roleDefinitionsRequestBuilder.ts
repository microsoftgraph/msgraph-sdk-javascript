...
/** Builds and executes requests for operations under /roleManagement/entitlementManagement/roleDefinitions  */
export class RoleDefinitionsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
