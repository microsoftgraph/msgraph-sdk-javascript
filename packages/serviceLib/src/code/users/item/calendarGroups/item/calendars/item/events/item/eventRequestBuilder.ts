...
import {EventRequestBuilder as i801ac2b106d39052210afec9edfdda8acbf245b858f5b47d920784626f83a8e0} from './instances/item/';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : i801ac2b106d39052210afec9edfdda8acbf245b858f5b47d920784626f83a8e0 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new i801ac2b106d39052210afec9edfdda8acbf245b858f5b47d920784626f83a8e0(urlTplParams, this.requestAdapter);
    };
    /**
