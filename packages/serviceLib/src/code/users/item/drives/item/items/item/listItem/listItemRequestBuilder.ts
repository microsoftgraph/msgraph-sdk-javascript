...
export class ListItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/items/{driveItem_id}/listItem{?select,expand}";
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.items.item.listItem.versions.item collection
