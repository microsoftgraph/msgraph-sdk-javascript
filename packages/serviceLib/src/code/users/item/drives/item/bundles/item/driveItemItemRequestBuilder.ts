...
import {DriveItemItemRequestBuilder as i837a384ac83ca1a9b2345d90061502da014eefbb264997ffbb7f3cbc2131cc3f} from './children/item/driveItemItemRequestBuilder';
...
export class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.bundles.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a driveItemItemRequestBuilder
     */
    public childrenById(id: string) : i837a384ac83ca1a9b2345d90061502da014eefbb264997ffbb7f3cbc2131cc3f {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem_id1"] = id
        return new i837a384ac83ca1a9b2345d90061502da014eefbb264997ffbb7f3cbc2131cc3f(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.bundles.item.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.bundles.item.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.bundles.item.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.bundles.item.versions.item collection
     * @param id Unique identifier of the item
