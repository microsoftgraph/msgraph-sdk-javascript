...
import {DriveItemItemRequestBuilder as i86d1f792d189eedc78d66d5b12c79128059273faa181ed2d915edaa0b10df69e} from './children/item/driveItemItemRequestBuilder';
...
export class DriveItemItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.following.item.children.item collection
     * @param id Unique identifier of the item
     * @returns a driveItemItemRequestBuilder
     */
    public childrenById(id: string) : i86d1f792d189eedc78d66d5b12c79128059273faa181ed2d915edaa0b10df69e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem_id1"] = id
        return new i86d1f792d189eedc78d66d5b12c79128059273faa181ed2d915edaa0b10df69e(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.following.item.permissions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.following.item.subscriptions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.following.item.thumbnails.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.drives.item.following.item.versions.item collection
     * @param id Unique identifier of the item
