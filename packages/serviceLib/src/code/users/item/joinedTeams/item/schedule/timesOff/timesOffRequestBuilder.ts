...
export class TimesOffRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/schedule/timesOff{?top,skip,search,filter,count,orderby,select}";
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: TimeOff | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
     ...
     */
    public post(body: TimeOff | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TimeOff | undefined> {
        if(!body) throw new Error("body cannot be undefined");
