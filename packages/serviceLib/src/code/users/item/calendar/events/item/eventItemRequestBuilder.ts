...
import {EventItemRequestBuilder as i418e0fd08c9e5dbdfd4f21643c9610d533adfa599260ad0fb5cb8168f40c47a8} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i418e0fd08c9e5dbdfd4f21643c9610d533adfa599260ad0fb5cb8168f40c47a8 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new i418e0fd08c9e5dbdfd4f21643c9610d533adfa599260ad0fb5cb8168f40c47a8(urlTplParams, this.requestAdapter);
    };
    /**
