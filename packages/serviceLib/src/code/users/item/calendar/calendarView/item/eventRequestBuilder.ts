...
import {EventRequestBuilder as i9f026f30430d8ffb6f8216dd8d79ab11ff6f481361932d2d50627a42ce0a456e} from './instances/item/';
...
export class EventRequestBuilder {
     ...
     */
    public instancesById(id: string) : i9f026f30430d8ffb6f8216dd8d79ab11ff6f481361932d2d50627a42ce0a456e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event_id1"] = id
        return new i9f026f30430d8ffb6f8216dd8d79ab11ff6f481361932d2d50627a42ce0a456e(urlTplParams, this.requestAdapter);
    };
    /**
