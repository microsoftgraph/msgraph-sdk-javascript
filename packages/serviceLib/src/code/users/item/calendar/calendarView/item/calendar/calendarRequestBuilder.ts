...
/** Builds and executes requests for operations under /users/{user-id}/calendar/calendarView/{event-id}/calendar  */
export class CalendarRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/calendar/calendarView/{event_id}/calendar{?select}";
