...
import {MeetingAttendanceReportItemRequestBuilder} from './attendanceReports/item/';
...
export class OnlineMeetingItemRequestBuilder {
    ...
    /**
     * Gets an item from the MicrosoftGraph.users.item.onlineMeetings.item.attendanceReports.item collection
     ...
     * @returns a RequestInformation
     */
    public createPatchRequestInformation(body: OnlineMeeting | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
    ...
    public get(q?: {
                    expand?: string[],
                    select?: string[]
                    } | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OnlineMeeting | undefined> {
     ...
     * @param responseHandler Response handler to use in place of the default response handling provided by the core service
     */
    public patch(body: OnlineMeeting | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<void> {
        if(!body) throw new Error("body cannot be undefined");
