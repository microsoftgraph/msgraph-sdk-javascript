...
/** Builds and executes requests for operations under /users/{user-id}/events/{event-id}/calendar/$ref  */
export class RefRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/events/{event_id}/calendar/$ref";
