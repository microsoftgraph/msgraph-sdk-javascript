...
/** Builds and executes requests for operations under /users/{user-id}/onenote/notebooks  */
export class NotebooksRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/onenote/notebooks{?top,skip,search,filter,count,orderby,select,expand}";
