...
export class MultiValueLegacyExtendedPropertyItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/users/{user_id}/contactFolders/{contactFolder_id}/childFolders/{contactFolder_id1}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty_id}{?select,expand}";
