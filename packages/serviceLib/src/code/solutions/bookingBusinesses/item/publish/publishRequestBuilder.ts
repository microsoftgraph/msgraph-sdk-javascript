...
/** Builds and executes requests for operations under /solutions/bookingBusinesses/{bookingBusiness-id}/microsoft.graph.publish  */
export class PublishRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness_id}/microsoft.graph.publish";
