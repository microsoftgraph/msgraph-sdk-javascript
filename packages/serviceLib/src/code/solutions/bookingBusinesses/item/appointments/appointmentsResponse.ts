...
export class AppointmentsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as AppointmentsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as AppointmentsResponse).value = n.getCollectionOfObjectValues<BookingAppointment>(BookingAppointment); }],
        ]);
    };
    /**
