...
export class MdmWindowsInformationProtectionPoliciesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as MdmWindowsInformationProtectionPoliciesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as MdmWindowsInformationProtectionPoliciesResponse).value = n.getCollectionOfObjectValues<MdmWindowsInformationProtectionPolicy>(MdmWindowsInformationProtectionPolicy); }],
        ]);
    };
    /**
