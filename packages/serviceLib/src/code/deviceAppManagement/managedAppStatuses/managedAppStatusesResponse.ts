...
export class ManagedAppStatusesResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as ManagedAppStatusesResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as ManagedAppStatusesResponse).value = n.getCollectionOfObjectValues<ManagedAppStatus>(ManagedAppStatus); }],
        ]);
    };
    /**
