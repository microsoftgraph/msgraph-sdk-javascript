...
export class TeamsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as TeamsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as TeamsResponse).value = n.getCollectionOfObjectValues<Team>(Team); }],
        ]);
    };
    /**
