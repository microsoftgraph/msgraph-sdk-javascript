...
/** Builds and executes requests for operations under /teams/{team-id}/primaryChannel/members  */
export class MembersRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/teams/{team_id}/primaryChannel/members{?top,skip,search,filter,count,orderby,select,expand}";
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: ConversationMember | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
     ...
     */
    public post(body: ConversationMember | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ConversationMember | undefined> {
        if(!body) throw new Error("body cannot be undefined");
