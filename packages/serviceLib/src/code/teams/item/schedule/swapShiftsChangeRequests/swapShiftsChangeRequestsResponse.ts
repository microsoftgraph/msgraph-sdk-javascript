...
export class SwapShiftsChangeRequestsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as SwapShiftsChangeRequestsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as SwapShiftsChangeRequestsResponse).value = n.getCollectionOfObjectValues<SwapShiftsChangeRequest>(SwapShiftsChangeRequest); }],
        ]);
    };
    /**
