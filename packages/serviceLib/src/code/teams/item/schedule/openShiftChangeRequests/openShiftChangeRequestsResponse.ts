...
export class OpenShiftChangeRequestsResponse implements Parsable {
    ...
    public getFieldDeserializers<T>() : Map<string, (item: T, node: ParseNode) => void> {
        return new Map<string, (item: T, node: ParseNode) => void>([
            ["@odata.nextLink", (o, n) => { (o as unknown as OpenShiftChangeRequestsResponse).nextLink = n.getStringValue(); }],
            ["value", (o, n) => { (o as unknown as OpenShiftChangeRequestsResponse).value = n.getCollectionOfObjectValues<OpenShiftChangeRequest>(OpenShiftChangeRequest); }],
        ]);
    };
    /**
