...
export class SchedulingGroupsRequestBuilder {
     ...
     * @returns a RequestInformation
     */
    public createPostRequestInformation(body: SchedulingGroup | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined) : RequestInformation {
     ...
     */
    public post(body: SchedulingGroup | undefined, h?: Record<string, string> | undefined, o?: Record<string,RequestOption> | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SchedulingGroup | undefined> {
        if(!body) throw new Error("body cannot be undefined");
