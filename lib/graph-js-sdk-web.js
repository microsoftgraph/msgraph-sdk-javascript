            ...
            _this.config.authProvider((err, accessToken) => {
                ...
                request.end((err, res) => {
                    if (res && res.ok) {
                        ...
                        reject(ResponseHandler_1.ResponseHandler.ParseError((err == null && res.error !== null) ? res : err));
                    }
                });
            });
        });
...
},{"../../package.json":11,"./ResponseHandler":3,"./common":4,"superagent":6}],3:[function(require,module,exports){
"use strict";
...
},{"./is-object":7,"./request":9,"./request-base":8,"emitter":10}],7:[function(require,module,exports){
/**
