...
},{"./lib/src/index.js":4}],2:[function(require,module,exports){
"use strict";
...
class GraphRequest {
    ...
    static parseError(rawErr) {
        ...
        if (!('rawResponse' in rawErr)) {
            if ('error' in rawErr.response.body) {
    ...
    parsePath(rawPath) {
        ...
        if (queryStrPos == -1) {
            ...
            for (let queryParam of queryParams) {
                ...
                let key = param[0];
                let value = param[1];
                if (CommonObj_1.oDataQueryNames.indexOf(key)) {
    ...
    static handleResponse(err, res, callback) {
        if (res && res.ok) {
...
},{"../../package.json":10,"./CommonObj":2,"superagent":6}],4:[function(require,module,exports){
'use strict';
const CommonObj_1 = require("./CommonObj");
...
},{"./CommonObj":2,"./GraphRequest":3}],5:[function(require,module,exports){
...
},{"./is-object":7,"./request":9,"./request-base":8,"emitter":5}],7:[function(require,module,exports){
/**
