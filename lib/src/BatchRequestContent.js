...
var BatchRequestContent = /** @class */ (function () {
    ...
    BatchRequestContent.prototype.content = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self, requestBody, requests, iterator, cur, error, error, requestStep, batchRequestData;
    ...
    BatchRequestContent.getRequestBody = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var bodyParsed, body, cloneReq, e_2, blob_1, reader_1, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bodyParsed = false;
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4:
                        if (!!bodyParsed) return [3 /*break*/, 10];
                        _a.label = 5;
                    case 5:
                        _a.trys.push([5, 9, , 10]);
                        if (!(typeof request.blob === "function")) return [3 /*break*/, 8];
                        return [4 /*yield*/, request.blob()];
                    case 6:
                        blob_1 = _a.sent(), reader_1 = new FileReader();
                        return [4 /*yield*/, new Promise(function (resolve) {
                                reader_1.addEventListener("load", function () {
                                    var dataURL = reader_1.result, regex = new RegExp("^\s*data:(.+?\/.+?(;.+?\=.+?)*)?(;base64)?,(.*)\s*$"), segments = regex.exec(dataURL);
                                    resolve(segments[4]);
                                }, false);
