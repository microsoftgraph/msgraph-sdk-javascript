...
var HTTPMessageHandler = /** @class */ (function () {
    ...
    HTTPMessageHandler.prototype.convertResponse = function (response, type) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                self = this;
                switch (type) {
                    case IResponseType_1.ResponseType.ARRAYBUFFER:
                        responseValue = response.arrayBuffer();
                        break;
                    case IResponseType_1.ResponseType.BLOB:
                        responseValue = response.blob();
                        break;
                    case IResponseType_1.ResponseType.DOCUMENT:
                        responseValue = self.parseDocumentResponse(response, DocumentType.TEXT_XML);
                        break;
                    case IResponseType_1.ResponseType.JSON:
                        responseValue = response.json();
                        break;
                    case IResponseType_1.ResponseType.STREAM:
                        responseValue = Promise.resolve(response.body);
                        break;
                    case IResponseType_1.ResponseType.TEXT:
    ...
    HTTPMessageHandler.prototype.execute = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var self_1, optionsHeaders, middlewareOptionsHeaders, rawResponse, responseType, response, error_1, self_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        self_1 = this, optionsHeaders = Object.assign({}, context.options.headers);
