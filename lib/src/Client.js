...
var DefaultAuthenticationProvider_1 = require("./DefaultAuthenticationProvider");
...
var Client = /** @class */ (function () {
    ...
    Client.init = function (options) {
        var clientOptions = {}, httpClient;
        for (var i in options) {
            if (i === "authProvider") {
                clientOptions[i] = new DefaultAuthenticationProvider_1.DefaultAuthenticationProvider(options[i]);
            }
