...
var LargeFileUploadUtil_1 = require("./LargeFileUploadUtil");
;
var LargeFileUploadTask = (function () {
    function LargeFileUploadTask(client, file, uploadSession, options) {
        ...
        self.client = client;
        self.file = file;
        options.rangeSize = LargeFileUploadUtil_1.getValidRangeSize(options.rangeSize);
        self.options = options;
        self.uploadSession = uploadSession;
        self.nextRange = new Range_1.Range(0, self.options.rangeSize - 1);
    }
    LargeFileUploadTask.create = function (client, file, options) {
        return __awaiter(this, void 0, void 0, function () {
            var self, _fileObject, _file, b, payload, session, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = LargeFileUploadTask, _fileObject = {};
                        ...
                        switch (file.constructor.name) {
                            case "Blob":
                                ...
                                _fileObject.content = new File([file], _fileObject.name);
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, LargeFileUploadTask.createUploadSession(client, options.sessionRequestUrl, payload)];
                    case 2:
                        session = _a.sent();
                        return [2, new LargeFileUploadTask(client, _fileObject, session, options)];
                    case 3:
                        err_1 = _a.sent();
                        throw err_1;
                    case 4: return [2];
    ...
    LargeFileUploadTask.createUploadSession = function (client, requestUrl, requestPayload) {
        return __awaiter(this, void 0, void 0, function () {
            var createSession, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, client.api(requestUrl).post(requestPayload)];
                    case 1:
                        createSession = _a.sent();
                        return [2, {
    ...
    LargeFileUploadTask.getRandomFileName = function () {
    ...
    LargeFileUploadTask.prototype.upload = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self, nextRange, err, fileSlice, response, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (self.uploadSession.expiry.getTime() <= Date.now()) {
                            err = new Error("Task with which you are uploading is no longer valid, Please create new task to upload");
                            err.name = "Invalid Session";
                            throw err;
                        }
                        return [4, self.client
    ...
    LargeFileUploadTask.prototype.commit = function (requestUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var self, payload, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
