...
var LargeFileUploadTask = /** @class */ (function () {
    ...
    LargeFileUploadTask.create = function (client, file, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _fileObject, _file, b, payload, session, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, LargeFileUploadTask.createUploadSession(client, options.sessionRequestUrl, payload)];
                    case 2:
                        session = _a.sent();
                        return [2 /*return*/, new LargeFileUploadTask(client, _fileObject, session, options)];
                    case 3:
                        err_1 = _a.sent();
                        throw err_1;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, client.api(requestUrl).post(requestPayload)];
                    case 1:
