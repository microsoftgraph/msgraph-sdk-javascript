...
var LargeFileUploadTask = (function () {
    ...
    LargeFileUploadTask.create = function (client, file, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _file, randomFileName, payload, session, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (file.constructor.name === "Blob") {
                            randomFileName = "Upload_" + new Date().toDateString().replace(/ /g, "_");
                    ...
                    case 2:
                        session = _a.sent();
                        return [2, new LargeFileUploadTask(client, _file, session, options)];
                    case 3:
                        err_1 = _a.sent();
                        throw err_1;
                    case 4: return [2];
    ...
    LargeFileUploadTask.prototype.sliceFile = function (range) {
        var blob = this.file.slice(range.minValue, range.maxValue + 1);
        return blob;
    };
