...
var IRequestMethod_1 = require("./IRequestMethod");
var IResponseType_1 = require("./IResponseType");
/**
 * @class
...
var GraphRequest = /** @class */ (function () {
    ...
    */
     ...
     */
    GraphRequest.prototype.send = function (request, options) {
                ...
                switch (_a.label) {
                    case 0:
                        self = this, url = self.buildFullUrl(), options = {
                            method: IRequestMethod_1.RequestMethod.GET
                        };
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, self.send(url, options)];
                    case 2:
                        response = _a.sent();
     ...
     */
    GraphRequest.prototype.post = function (content) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this, url = self.buildFullUrl(), options = {
                            method: IRequestMethod_1.RequestMethod.POST,
     ...
     * @return A promise that resolves to the post response
     */
    GraphRequest.prototype.create = function (content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.post(content)];
     ...
     */
    GraphRequest.prototype.put = function (content) {
        return __awaiter(this, void 0, void 0, function () {
            var self, url, options, response;
            return __generator(this, function (_a) {
                self = this, url = self.buildFullUrl(), options = {
                    method: IRequestMethod_1.RequestMethod.PUT,
                    body: GraphRequestUtil_1.serializeContent(content),
                    headers: {
     ...
     */
    GraphRequest.prototype.patch = function (content) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this, url = self.buildFullUrl(), options = {
                            method: IRequestMethod_1.RequestMethod.PATCH,
                            body: GraphRequestUtil_1.serializeContent(content),
                            headers: {
                                "Content-Type": "application/json"
                            }
     ...
     * @return A promise that resolves to the patch response
     */
    GraphRequest.prototype.update = function (content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.patch(content)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    GraphRequest.prototype.delete = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this, url = self.buildFullUrl(), options = {
                            method: IRequestMethod_1.RequestMethod.DELETE
                        };
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
     ...
     * @return A promise that resolves to the delete response
     */
    GraphRequest.prototype.del = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    GraphRequest.prototype.getStream = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        self.responseType(IResponseType_1.ResponseType.STREAM);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, self.send(url, options)];
     ...
     */
    GraphRequest.prototype.putStream = function (stream) {
        return __awaiter(this, void 0, void 0, function () {
