            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(request.method === IRequestMethod_1.RequestMethod.PATCH || request.method === IRequestMethod_1.RequestMethod.POST || request.method === IRequestMethod_1.RequestMethod.PUT)) return [3 /*break*/, 2];
                        _a = requestData;
